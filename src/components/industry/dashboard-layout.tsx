...
interface IndustryDashboardLayoutProps {
    children: React.ReactNode;
}

export function IndustryDashboardLayout({ children }: IndustryDashboardLayoutProps) {
            ...
            <Sidebar>
                <SidebarHeader>
                    <div className="flex items-center gap-2 px-2">
                        <Link href="/industry/dashboard" className="flex items-center gap-2">
                        ...
                        <SidebarGroupContent>
                            <SidebarMenu>
                                <SidebarMenuItem>
                                    <SidebarMenuButton
                                        asChild
                                        isActive={isActive('/industry/dashboard')}
                                    >
